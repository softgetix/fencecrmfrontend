            ...
            <div className="col-lg-5 col-md-5 col-sm-12 col-xs-12">
              <div className="footer-1">
                <div>
                  <img
                    src="mokeup/img3.png"
                    className="fence-crm__main-logo"
                    alt="https://fencecrm.com/"
                  />
                </div>
                ...
                <div className="db-block">
                  <p className="footer-text">
                    Call us at <a href="tel:+91-731-4002699">+91-731-4002699</a>
                  </p>
                  <p className="footer-text">
                    Email us at : {" "}
                    <a href="mail:support@fencecrm.com">support@fencecrm.com</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="d-md-flex justify-content-between">
            ...
            <div className="widget widget-links widget-light pb-4 pt-4">
              <ul className="d-flex flex-wrap justify-content-center justify-content-md-start footer-menu">
                <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-377">
                  <a title="Help Center" href="/support">
                    Help Center
                  </a>
                </li>
                <li>|</li>
                <li className="menu-item menu-item-type-custom menu-item-object-custom current-menu-item active menu-item-379">
                  <a title="Privacy policy" href="/privacy-policy/">
                    Privacy policy
                  </a>
                </li>
                <li>|</li>
                <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-380">
                  <a
